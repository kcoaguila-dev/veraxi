...
def insert_vectors(texts: list[str], tenant_id: str = "default") -> dict[str, Any]:
    """
    ...
    for text in texts:
        ...
        payloads.append({"text": text, "tenant_id": tenant_id})
    ...
    return {"status": "success", "vectors_inserted": 0, "point_ids": []}
