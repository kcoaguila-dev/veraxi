...
def test_resolve_entities_deduplication():
    ...
    entities = [
        ...
        {"type": "Organization", "name": "Veraxi Corp", "properties": {"industry": "Tech"}},
        {"type": "Organization", "name": "Veraxi Corp", "properties": {"founded": "2023"}},
    ...
    assert len(orgs) == 1, "Expected the three organizations to be deduplicated into one"
