...
void main() {
  ...
  test('fetchStats sets requiresPayment when PaymentRequiredException is thrown', () async {
    when(() => mockRepository.fetchStats()).thenAnswer((_) => Future.error(PaymentRequiredException()));
    viewModel = ControlPanelViewModel(mockRepository);
