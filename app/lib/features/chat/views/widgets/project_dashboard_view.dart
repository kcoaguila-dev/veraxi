...
class ProjectDashboardView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final projectThreads = state.pastThreads.where((t) => t['project_id'] == projectId).toList();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        const Icon(Icons.arrow_back, color: Color(0xFF878787), size: 16),
                ...
                Row(
                  children: [
                    const Icon(LucideIcons.folder, color: Colors.white, size: 32),
                ...
                Row(
                  ...
                  children: [
                    ...
                    const Row(
                      children: [
                        Icon(Icons.arrow_upward, color: Color(0xFF878787), size: 12),
                        SizedBox(width: 4),
                        Text(
                          'Updated',
                          style: TextStyle(
                    ...
                    child: projectThreads.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                onTap: () => viewModel.selectThread(thread['thread_id']),
                                title: Text(
                                  title,
